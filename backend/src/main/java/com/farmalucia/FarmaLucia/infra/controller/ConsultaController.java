...
import com.farmalucia.FarmaLucia.infra.service.ConsultaService;
...
public class ConsultaController {
    ...
    public String carregarPaginaAgendaConsulta(Long id, Model model) {
        if (id != null) {
            ...
            model.addAttribute("dados", new DadosAgendamentoConsultaDTO(null, null, "", null, null));
        }
    ...
    @PostMapping
    public String cadastrar(@Valid @ModelAttribute("dados") DadosAgendamentoConsultaDTO dados, BindingResult result, Model model) {
        if (result.hasErrors()) {
