...
import com.farmalucia.FarmaLucia.infra.service.MedicoService;
...
public class MedicoController {
    ...
    public String carregarPaginaCadastro(Long id, Model model) {
        if (id != null) {
            ...
            model.addAttribute("dados", new DadosCadastroMedicoDTO(null, "", "", "", "", null, null, null));
        }
    ...
    @PostMapping
    public String cadastrar(@Valid @ModelAttribute("dados") DadosCadastroMedicoDTO dados, BindingResult result, Model model) {
        if (result.hasErrors()) {
    ...
    @ResponseBody
    public List<DadosListagemMedicoDTO> listarMedicosPorEspecialidade(@PathVariable String especialidade) {
